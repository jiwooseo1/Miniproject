...
<style>
	.topHeader {
		background-image: url('${contextPath }/resources/images/iceland.jpg');
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link active" href="${contextPath }/">jkw</a> 
      </li>
      <li class="nav-item">
        <a class="nav-link" href="${contextPath }/board/listAll">게시판</a>
      </li>
